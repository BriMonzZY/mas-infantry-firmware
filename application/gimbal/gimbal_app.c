...
struct offline_obj gimbal_offline_table[] =
{
    ...
    {OFFLINE_GIMBAL_TURN_MOTOR, ENABLE, OFFLINE_WARNING_LEVEL, 7, 100, NULL, NULL, NULL, NULL},
...
{
    {GIMBAL_ADDRESS, "can1_0x600_to_0x500"},  // 官方
//	{CHASSIS_ADDRESS, "can1_0x600_to_0x500"},
...
/**
  * @brief  gimbal adjust key 云台校准按键回调函数
  * @param
  * @retval void
  */
void gimbal_user_key_handle(void)
